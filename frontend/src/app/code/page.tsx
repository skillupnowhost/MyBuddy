...
export default function CodePage() {
  ...
  return (
    <div className="flex h-screen flex-col bg-white text-gray-900">
      <WorkspaceHeader icon={Code2} title="MyBuddy Code" />
        ...
        <aside className="flex w-64 shrink-0 flex-col border-r border-gray-200 bg-white">
          <div className="p-3">
            ...
            <button
              ...
              disabled={uploading}
              className="w-full rounded-xl border border-dashed border-gray-300 py-2 text-xs text-gray-500 transition hover:border-indigo-400 hover:text-gray-900 disabled:opacity-50"
            >
          ...
          <div className="flex items-center justify-between border-b border-gray-200 bg-white px-3 py-2">
            ...
            {isAdmin ? (
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-emerald-600 px-3 py-1 text-xs font-medium text-white shadow-sm transition hover:bg-emerald-500 hover:shadow disabled:opacity-40 disabled:shadow-none"
              >
          ...
          <div className="border-t border-gray-200 p-3">
            <div className="flex items-end gap-2">
              ...
              <button
                ...
                className="rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-3 py-2 text-sm font-medium text-white shadow-sm transition hover:from-indigo-500 hover:to-violet-500 hover:shadow disabled:opacity-40 disabled:shadow-none"
              >
                Send
              </button>
            </div>
